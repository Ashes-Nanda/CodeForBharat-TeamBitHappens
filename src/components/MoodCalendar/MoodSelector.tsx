...
interface MoodSelectorProps {
  date: Date;
  onClose: () => void;
  onSave: (date: Date, mood: string, reflection: string) => Promise<void>;
}

const MoodSelector = ({ date, onClose, onSave }: MoodSelectorProps) => {
  ...
  const handleSave = async () => {
    ...
    await onSave(date, selectedMood, reflection);
    onClose();
  };
